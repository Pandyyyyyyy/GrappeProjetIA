...
class GenAICache:
    ...
    def __init__(self, cache_file: str = "genai_cache.db"):
        ...
        Args:
            cache_file: Chemin vers le fichier de cache SQLite
        """
    ...
    def _generate_cache_key(self, prompt: str, model: str, function_name: str) -> str:
        ...
        Args:
            prompt: Le prompt envoyé à l'API
            model: Le modèle utilisé
            function_name: Le nom de la fonction (enrich_user_query, generate_profile_summary, etc.)
    ...
    def get(self, prompt: str, model: str, function_name: str) -> Optional[str]:
        ...
        Returns:
            La réponse en cache si trouvée, None sinon
        """
